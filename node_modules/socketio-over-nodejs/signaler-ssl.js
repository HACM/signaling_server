...
var mipuerto = process.env.PORT || 8080;
...
*/
var options = {
    key: fs.readFileSync('./node_modules/socketio-over-nodejs/fake-keys/privatekey.pem'),
    cert: fs.readFileSync('./node_modules/socketio-over-nodejs/fake-keys/certificate.pem')
};
...
//app.listen(8888);
app.listen(mipuerto);
console.log("Escuchando el puerto: "+mipuerto);
